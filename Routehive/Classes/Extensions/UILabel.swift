        ...
        set{
            ...
            if !isAttribute {
                ...
                if let attributedText = self.attributedText
                {
                    ...
                    let range = (attributedTitle.string as NSString).range(of: boldText)
                    
                    attributedTitle.addAttribute(NSAttributedStringKey.font, value: regularFontApply, range: NSRange(location: 0, length: attributedText.string.length))
